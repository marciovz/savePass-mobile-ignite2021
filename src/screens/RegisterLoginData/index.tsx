...
export function RegisterLoginData() {
  ...
  async function handleRegister(formData: FormData) {
    ...
    const storagePassList = storage ? JSON.parse(storage) : [];

    const newPassListToStorage = JSON.stringify([ ...storagePassList, newLoginData]);
    await AsyncStorage.setItem(dataKey, newPassListToStorage);
